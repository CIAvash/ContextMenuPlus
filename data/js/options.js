$(function() {
	...
	function checkOptions(opts) {
		...
		$("#cTitleURLTabs").prop("checked", opts.cTitleURLTabs);
		...
		$("#csTextURL").prop("checked", opts.csTextURL);
    ...
    $('#save_btn').click(function() {
    	...
    	if($("#cTitleURLTabs").is(':checked')) {
    		options.cTitleURLTabs = true;
    	} else { options.cTitleURLTabs = false; }
    	...
    	if($("#cpAsLink").is(':checked')) {
    		options.cpAsLink = true;
    	} else { options.cpAsLink = false; }
    	...
    	if($("#csTextURL").is(':checked')) {
    		options.csTextURL = true;
    	} else { options.csTextURL = false; }
