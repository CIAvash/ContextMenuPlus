...
var pTitleItem = true, purlItem = true, phLinkItem = true, pHostnameItem = true, pTextItem = true, hCodeItem = true, lTextItem = true, lHostnameItem = true, textTitleHotkey = true, purlHotkey = true;
