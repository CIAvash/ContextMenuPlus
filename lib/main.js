...
var pTitleItem = true, purlItem = true, ptURLItem = true, tURLTabsItem = true, phLinkItem = true, paLinkItem = true, pHostnameItem = true, pTextItem = true, thLinkItem = true, taLinkItem = true, hCodeItem = true, lTextItem = true, lHostnameItem = true, textTitleHotkey = true, purlHotkey = true;
function refresh_addon() {
	...
	if(db.storage.options.cTitleURLTabs && tURLTabsItem) {
		titleURLTabsItem = contextMenu.Item({
		  label: "Copy Titles & URLs of all Tabs",
		  contentScript: 'self.on("click", function (node, data) {' +
				         '	self.postMessage("");' +
				         '});',
		  onMessage: function () {
