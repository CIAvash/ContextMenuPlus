...
var pTitleItem = true, purlItem = true, ptURLItem = true, phLinkItem = true, paLinkItem = true, pHostnameItem = true, pTextItem = true, hCodeItem = true, lTextItem = true, lHostnameItem = true, textTitleHotkey = true, purlHotkey = true;
