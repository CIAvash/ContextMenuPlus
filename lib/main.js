...
var pTitleItem = true, purlItem = true, pHostnameItem = true, pTextItem = true, pHtmlItem = true, lTextItem = true, lHostnameItem = true, textTitleHotkey = true, purlHotkey = true;
function refresh_addon() {
	...
	if(db.storage.options.cAsHtml && pHtmlItem) {
		...
		pHtmlItem = false;
	} else if(!db.storage.options.cAsHtml && !pHtmlItem) {
		asHtmlItem.destroy();
		pHtmlItem = true;
	}
